...
sudo cp ~/Downloads/Tiny-Banned-Book-Library/nodogsplash-files/* /etc/nodogsplash/htdocs
...
sudo cp ~/Downloads/Tiny-Banned-Book-Library/dnsmasq.conf /etc/dnsmasq.conf
sudo cp ~/Downloads/Tiny-Banned-Book-Library/dhcpcd.conf /etc/dhcpcd.conf
sudo rfkill unblock wlan
sudo cp ~/Downloads/Tiny-Banned-Book-Library/hostapd.conf /etc/hostapd/hostapd.conf
sudo systemctl stop systemd-resolved
sudo cp ~/Downloads/Tiny-Banned-Book-Library/rc-disabled.local /etc/rc.local
